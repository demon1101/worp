...
const char * const BITCOIN_CONF_FILENAME = "worp.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Worp
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Worp
    // Mac: ~/Library/Application Support/Worpcoin
    // Unix: ~/.worp
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Worp";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Worp";
#else
    // Unix
    return pathRet / ".worp";
#endif
