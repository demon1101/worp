...
{
    const char* pszTimestamp = "WORP genesis block creates a new independent Scrypt blockchain, 2025";
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.nRuleChangeActivationThreshold = 90; // 75%
...
;
	...
	genesis = CreateGenesisBlock(1766275200, 0, 0x207fffff, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x781851c2e72336c2e7525f5cd6792cf2eca0fa1890e3bd219051f7a7ef461da5"));
        assert(genesis.hashMerkleRoot == uint256S("0xa0b6ec496d3c9be48f0157a6dd6c3f2906acd5b450aa28c884b45488208dcf31"));
